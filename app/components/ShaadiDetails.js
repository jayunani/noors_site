        ...
        <div className='shaadi-content'>
          <div className='event-details'>
            ...
            <div className='event-schedule'>
              ...
              <div> 6 PM </div>
              <div> The Abbas Family graciously thanks you for taking the time to RSVP. 
                  We would be honored to have you share this joyous occasion with us. May Allah
                  put Barakah in our time and families. Ameen! </div>
            </div>
          ...
          <div className='shaadi-map' id='map'>
            ...
            <div><img src='/img/diamond_bar.png' /></div>
          </div>
        </div>
      </div>
    );
